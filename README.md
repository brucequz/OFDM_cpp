# OFDM_cpp
A personal project intended to investigate BER performance of vanilla OFDM system and the effect of error correction coding.

## Getting Started
### How to set up?
The author of this project uses C++(14) and MATLAB(R_2022b). 
### Dependencies
...
### Debug Info
I use the built-in lldb debugger and AddressSanitizer for this project. 
